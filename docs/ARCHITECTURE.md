...
2.  `CacheSchemaMigrator` creates or repairs the required SQLite tables and columns inside a transaction, normalizes known legacy mod-primary pairs, migrates legacy priorities, and records the supported schema version (currently 9).
