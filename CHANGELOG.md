...
### Added
- Added an embedded character/ship catalog with localized-name and portrait resolution, best-effort Comlink catalog refresh, atomic catalog persistence, audit summaries, validated Settings import, and bundled portrait/initials UI fallbacks.
